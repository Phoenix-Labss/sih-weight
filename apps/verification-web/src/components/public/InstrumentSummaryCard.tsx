  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-card p-5 space-y-4 text-xs">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
        ...
        <div>
          <span className="text-slate-500 block text-xs">Model & Type:</span>
        ...
        <div>
          <span className="text-slate-500 block text-xs">Physical Serial Number:</span>
          <div className="flex items-center gap-2">
            <span className="font-mono font-bold text-slate-900 text-sm">{summary.masked_serial_number}</span>
            <span className="text-xs text-slate-400 font-sans">(Masked for Privacy)</span>
          </div>
        </div>

        <div>
          <span className="text-slate-500 block text-xs">Maximum Capacity (Max):</span>
      ...
      <div className="pt-3 border-t border-slate-100">
        <span className="text-slate-500 block text-xs mb-0.5">Issuing Legal Metrology Authority:</span>
