...
import { Scale, Shield, Lock, Eye, EyeOff, UserPlus, CheckCircle2 } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 py-5">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-slate-900 font-bold text-xs flex items-center gap-1.5 shadow-sm transition-colors"
            >
              <UserPlus className="w-4 h-4" />
              <span>New Establishment Registration</span>
            </button>
          </div>
        </div>
      </header>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gov-border p-8">
            ...
            <div className="mt-4 text-center">
              <button
                type="button"
                onClick={() => setIsRegisterOpen(true)}
                className="text-xs font-semibold text-gov-blue hover:text-blue-800 hover:underline inline-flex items-center gap-1"
              >
                <span>New business or scale user? Register establishment here →</span>
              </button>
            </div>
